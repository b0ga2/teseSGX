...
\Abstract{palavras-chave}{computação confidencial, Intel SGX, posicionamento WiFi, monitorização de ocupação, análise com preservação da privacidade, gestão segura da memória}
        ...
        \\No entanto, as implementações SGX padrão enfrentam dificuldades com o processamento de dados em grande escala devido ao tamanho restrito do cache de página do enclave e à sobrecarga de desempenho 
        da paginação nativa. 
        \\Este trabalho propõe uma arquitetura de processamento seguro centralizada com um mecanismo de paginação de software personalizado no nível do aplicativo, projetado para 

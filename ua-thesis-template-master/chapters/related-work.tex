...
This suggests that the system identifies the type of user based on the specific Wi-Fi network they connect to, allowing for distinct tracking of 
...
In 2016, \citet{10_10.1145/2971648.2971657} proposed the EDUM (EDUcation Measurement) system to characterize educational behaviors using data collected from large-scale Wi-Fi infrastructures, 
this system analyzes students punctuality based on longitudinal Wi-Fi connection traces and to assess lecture attractiveness and student distraction, 
the system utilizes the mobile phone's "interactive state" (screen on/off status) at a per-minute granularity.
...
The authors utilized daily Wi-Fi logs from the university's IT department, a scenario identical to this thesis, comprising 
...
this once more demonstrated that existing Wi-Fi infrastructure can yield accurate occupancy estimation 
...
with Wi-Fi network analysis to verify the student's location. 

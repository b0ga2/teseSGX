...
positioning and presence detection in indoor environments using Wifi, also taking in account
how the privacy and security of the data was handled, if it was.

\noindent Driven by technological advancements and institutional needs, nearly all 
buildings are now equipped with internet access provided through 
Wireless Access Points (APs). These allow for the determination of user location with a reasonable degree 
of precision, due to the need of the user to authenticate to a specific AP 
in order to use the local network.

\noindent Although useful for generating interesting statistics, indoor location and presence detection
...
\noindent Example of sensitive information used for indoor location:
...
\noindent The aggregation of this data creates a risk of linkability, allowing otherwise anonymous 
...
\subsection{Technologies used for Indoor Positioning}

Falar de sinais de rádio, bluetooth, sensores de CO2, camâras, sensores de movimento, RFID

...
This design establishes a dual layer, combining the hardware-enforced protection of the \ac{sgx} enclave with the software-based sandboxing of the Wasm runtime. 

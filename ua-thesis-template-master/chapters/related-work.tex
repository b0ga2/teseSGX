...
The domain of privacy-preserving data processing is made of statistical methodologies, ranging from syntactic models like k-anonymity to rigorous semantic 
...
For the present use case of occupancy monitoring, where precision is required, this trade-off is not acceptable, consequently, this work moves away 

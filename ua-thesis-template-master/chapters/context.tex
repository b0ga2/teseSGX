...
Then the discussion focuses on Intel \ac{sgx}, detailing its architecture, workflow, and security mechanisms. 
...
is separated from the main 32-bit core, but directly integrated in the \ac{cpu}, besides this, it also allows remote attestation.
\begin{figure}
  \includegraphics[width=\linewidth]{figs/amd_sev_snp_architecture.png}

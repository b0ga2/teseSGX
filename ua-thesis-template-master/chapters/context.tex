...
\ac{ap}s. 
These allow for the determination of user location with a reasonable degree of precision, as users must connect to a specific \ac{ap} to access the network, 
and every attempt, successful or not, is logged.

Although often categorized as technical metadata, it presents privacy challenges when observed through the lens of sensitive data. 
...
of occupancy analytics, but from a contractual obligation imposed on institutions that implement the eduroam network. 

...
\begin{figure}
  \begin{center}
  \includegraphics[scale=0.8]{figs/ree_vs_tee.png}
...
\begin{figure}
  \begin{center}
  \includegraphics[scale=1.1]{figs/TrustZone_architecture.png}
...
\begin{figure}
  \begin{center}
  \includegraphics[scale=1.25]{figs/amd_sev_snp_architecture.png}
